...
```
HeavyD/
├── AdminPanel/          # Admin dashboard (Next.js)
├── Dashboard/           # Client dashboard (Next.js)
├── Website/             # Public website with quote form (Next.js)
└── GoogleScript/        # Google Apps Script files for backend
    ├── website.gs       # Handles website form submissions
    ├── dashboard.gs     # Handles client dashboard API
    ├── revision.gs      # Handles revision updates and emails
    └── QuoteAccepted.html  # Quote acceptance confirmation page
```
